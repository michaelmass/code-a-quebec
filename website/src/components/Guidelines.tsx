		...
		<Container className="relative">
			...
			<div className="mt-6 max-w-4xl ml-auto mr-auto space-y-6 font-display text-xl tracking-tight text-blue-900">
				...
				<div className="space-y-2">
					...
					<p>
						Pas besoin d&apos;en faire trop, une simple question peut réveiller
						les esprits et briser la glace.
					</p>
				...
				<div className="space-y-2">
					...
					<p>
						Une petite répétition aide à gérer le temps, à éviter le stress, et
						à ne pas oublier et revenir à l&apos;arrière. On peut vraiment
				...
				<div className="space-y-2">
					...
					<p className="italic">
						&ldquo;Voici un problème que j&apos;ai rencontré, et comment je
						l&apos;ai réglé.&ldquo;
					</p>
					<p>
						Simple, efficace, et ça aide les gens à se projeter. Pas besoin
						d&apos;être révolutionnaire — du moment que c&apos;est clair et
						concret.
					</p>
					<p>Sinon, une bonne histoire ça aide aussi:</p>
					<p className="italic">
						&ldquo;parle-nous d&apos;un échec, d&apos;une galère en prod, ou
						d&apos;un truc que t&apos;as compris après coup.&ldquo;
					</p>
				</div>
				...
				<div className="space-y-2">
					...
					<p>
						<b>Explique les bases, évite le jargon</b>, et tout le monde restera
						avec toi.
					</p>
					...
					<i>
						...
						temps réel de grandes quantités de messages entre applications.
					</i>
				</div>
				...
				<div className="space-y-2">
					...
					<p>
						On est là pour partager notre passion pour la tech. Pas besoin de se
						prendre la tête — profite du moment, <b>sois toi-même!</b>
					</p>
				</div>
			</div>
		</Container>
