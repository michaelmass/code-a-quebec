  ...
  return (
    <Container className="relative">
      ...
      <div className="font-display mr-auto ml-auto max-w-4xl space-y-6 text-justify text-lg tracking-tight text-blue-900 sm:text-xl">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold">5. Répète ta présentation devant ton chat (au moins une fois)</h2>
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold">6. Un sujet clair & (problème / solution c&apos;est une recette gagnante)</h2>
