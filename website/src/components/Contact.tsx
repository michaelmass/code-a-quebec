	...
	return (
		<Container className="relative">
			<div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
				<h1 className="mb-4 font-display text-5xl font-bold tracking-tighter text-blue-600 sm:text-7xl">
					Contact & Feedback
				</h1>
				...
				<div className="mb-8">
					<p className="font-display mb-2 text-2xl gap-2 flex align-center tracking-tight text-blue-900">
						<NumberTitle number="2" /> Si tu veux aider à améliorer le meetup,
				...
				<div className="mb-8">
					<p className="font-display mb-2 text-2xl gap-2 flex align-center tracking-tight text-blue-900">
						<NumberTitle number="3" /> Est-ce que tu veux faire un talk au Code
						@ Québec ?
					</p>
					<p className="font-display tracking-tight text-blue-900">
						Écris un mail à{" "}
