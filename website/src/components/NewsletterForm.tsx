  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-blue-900/5 focus-within:ring-2 focus-within:ring-blue-900">
        {formState === SUCCESS ? (
          <p className="w-full text-center text-sm text-green-600">Merci pour ton inscription !</p>
        ) : (
          <>
            <input
      ...
      {formState === ERROR && <p className="mt-2 text-right text-sm text-red-500 sm:text-base">{errorMessage}</p>}
    </form>
  )
}
