...
export const Share = ({ children, className }: ShareProps) => {
  return (
    <Popover className={cn('relative', className)}>
      ...
      <PopoverPanel anchor={{ to: 'top', gap: '8px' }} className="flex rounded-xl bg-white p-2 shadow">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <Link href={`https://x.com/intent/post?url=${codeAQuebecUrl}`} target="_blank" rel="noopener noreferrer" className="inline-block font-light text-gray-400 hover:text-gray-500">
