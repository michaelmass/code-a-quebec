...
export const Share = ({ children, className }: ShareProps) => {
  return (
    <Popover className={cn('relative', className)}>
      ...
      <PopoverPanel anchor={{ to: 'top', gap: '8px' }} className="flex shadow p-2 rounded-xl bg-white ">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex justify-center gap-2 items-center">
            <Link
              ...
              className="text-gray-400 inline-block hover:text-gray-500 font-light"
            >
              <LinkedInLogo className="inline-block" height="16" width="16" viewBox="0 0 24 24" />
            </Link>
            <Link href={`https://x.com/intent/post?url=${codeAQuebecUrl}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 inline-block hover:text-gray-500 font-light">
