...
export const profiles = {
	...
	laurentLeclercPoulin: {
		...
		company: "@Nesto",
		profileLinkedIn:
			"https://www.linkedin.com/in/laurent-leclerc-poulin-570267131/",
	...
	},
	{
		...
		talks: [
			...
			},
			{
				...
				title:
					"Unlocking the Power of Pre-trained Models and Open-Source Ecosystems",
				summary: "",
				links: [],
			},
		],
	...
	},
	{
		...
		talks: [
			...
			},
			{
				...
				title:
					"A Dinosaur with a Blade: Revolutionizing CI with Deno and Dagger",
				summary: "",
				links: [],
			},
		],
